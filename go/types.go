// Package nameservers provides a Go client for the Nameservers API.
//
// For more information, visit: https://apiverve.com/marketplace/nameservers?utm_source=go&utm_medium=readme
package nameservers
...
// Request contains the parameters for the Nameservers API.
//
// Parameters:
//   - domain (required): string - The domain name to lookup nameservers for
type Request struct {
...
// ResponseData contains the data returned by the Nameservers API.
type ResponseData struct {
	Domain string `json:"domain"`
	Nameservers []NameserversItem `json:"nameservers"`
}

// NameserversItem represents an item in the Nameservers array.
type NameserversItem struct {
