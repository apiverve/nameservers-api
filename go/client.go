...
const (
	baseURL        = "https://api.apiverve.com/v1/nameservers"
	defaultTimeout = 30 * time.Second
)

// Client is the Nameservers API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Nameservers API client.
...
// Execute makes a request to the Nameservers API with typed parameters.
//
