...
class nameserversWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/nameservers');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/nameservers';
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/nameservers`);
        }
    }
...
module.exports = nameserversWrapper;
