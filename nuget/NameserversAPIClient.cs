...
namespace APIVerve.API.Nameservers
{
    ...
    /// <summary>
    /// Client for the Nameservers API
    /// </summary>
    public class NameserversAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/nameservers";
        ...
        public NameserversAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NameserversAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NameserversAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, NameserversQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(NameserversQueryOptions options)
        {
        ...
        public ResponseObj Execute(NameserversQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(NameserversQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(NameserversQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(NameserversQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(NameserversQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(NameserversQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(NameserversQueryOptions options)
        {
