...
```gradle
dependencies {
    implementation 'com.github.apiverve:nameservers-api:1.1.14'
}
```
...
```java
import com.apiverve.nameservers.NameserversAPIClient;
import com.apiverve.nameservers.APIResponse;
import com.apiverve.nameservers.APIException;

// Initialize the client
NameserversAPIClient client = new NameserversAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/nameservers](https://docs.apiverve.com/ref/nameservers)
...
- **Documentation:** [https://docs.apiverve.com/ref/nameservers](https://docs.apiverve.com/ref/nameservers)
- **Issues:** [GitHub Issues](https://github.com/apiverve/nameservers-api/issues)
